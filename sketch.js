...
function setup() {
  ...
  ground = new Base(0, height - 10, width * 2, 20, "yellow", true);
  leftWall = new Base(300, height / 2 + 50, 600, 100, "lavender", true);
  rightWall = new Base(width - 300, height / 2 + 50, 600, 100, "lavender", true);
